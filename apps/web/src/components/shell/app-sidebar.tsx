  ...
  return (
    ...
    >
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild size="lg" className="h-auto rounded-lg py-2">
              <Link href="/">
                <span className="relative flex size-9 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-[#111318]">
                  <Image
                    src="/brand-icon.png"
                    alt={`${APP_NAME} logo`}
                    width={40}
                ...
                <span className="grid flex-1 text-left leading-tight">
                  <span className="truncate text-[10px] font-bold uppercase tracking-[.18em] text-[#608800]">
                    PRINTFILM
                  </span>
                  <span className="truncate text-base font-extrabold text-[#111318]">{APP_NAME}</span>
                </span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
        <div className="mt-2 rounded-lg border border-[#e5e7eb] bg-[#f7f8fa] p-3 group-data-[collapsible=icon]:hidden">
                  ...
                  return (
                    <SidebarMenuItem key={`${group.label}-${item.label}`}>
                      <SidebarMenuButton
                        ...
                        isActive={active}
                        tooltip={item.label}
                        className="rounded-lg border-l-2 border-l-transparent data-[active=true]:border-[#dce3c9] data-[active=true]:border-l-[#9bd900] data-[active=true]:bg-[#efffc7] data-[active=true]:font-semibold data-[active=true]:text-[#111318]"
                      >
      ...
      <SidebarFooter className="border-t border-sidebar-border bg-white p-3">
        <div className="mb-2 space-y-4 overflow-hidden rounded-lg border border-[#e5e7eb] bg-[#f7f8fa] p-3 group-data-[collapsible=icon]:hidden">
          <div className="flex items-center justify-between gap-2">
            <span className="flex items-center gap-1.5 text-xs font-bold text-slate-800">
              <span className="grid size-6 place-items-center rounded-md bg-[#b6ff00] text-[#111318]">
                <Crown className="size-3.5" />
              </span>
              {t("creator.proPlan")}
            </span>
            <span className="rounded-full border border-[#d7ed9d] bg-[#efffc7] px-2 py-0.5 text-[10px] font-semibold text-[#466400]">
              {t("creator.upgrade")}
            </span>
          </div>
          <div>
            ...
            <div className="h-1.5 overflow-hidden rounded-full bg-slate-200/80">
              <div className="h-full w-[40%] rounded-full bg-[#b6ff00]" />
            </div>
          </div>
          <div>
            <div className="mb-1.5 flex justify-between gap-2 text-[10px] text-slate-500">
            ...
            <div className="h-1.5 overflow-hidden rounded-full bg-slate-200/80">
              <div className="h-full w-[43%] rounded-full bg-[#111318]" />
            </div>
          </div>
          <Link
            href="/creator?openApiKey=1"
            className="-mx-1 -mb-1 flex h-9 items-center gap-2 rounded-lg border border-[#e5e7eb] bg-white px-3 text-xs font-medium text-slate-700 transition hover:bg-[#efffc7] hover:text-[#111318]"
          >
            <KeyRound className="size-3.5 text-[#608800]" />
