...
import type { Project, ProjectType } from "@printfilm/shared-types";
        ...
        >
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-full bg-[#efffc7] px-2 py-0.5 text-xs text-[#466400]">
          ...
          <div className="flex items-center gap-2 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
            <Link
              ...
              className="rounded-lg bg-[#b6ff00] px-3 py-1.5 text-sm font-semibold text-[#111318] transition-colors hover:bg-[#a8f000]"
            >
