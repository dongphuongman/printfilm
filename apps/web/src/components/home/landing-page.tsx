...
const LANDING_CONTENT = {
  zh: {
    ...
    officeAddress: "实际办公地址",
    addressLines: ["深圳市宝安区新安街道海旺社区", "兴业路1100号金利通金融中心大厦2栋4302"],
    contact: "联系方式",
    customerService: "客服",
    landline: "座机",
    email: "邮箱",
    icp: "粤ICP备2025473821号-7",
    publicSecurity: "粤公网安备 44030002014945 号",
  },
  en: {
    nav: ["Capabilities", "Workflow", "FAQ"],
    enterCreator: "Open creation center",
    heroBadge: "AI-powered drama creation platform",
    heroTitle: "Turn inspiration into film",
    heroAccent: "Let every idea be seen",
    ...
    addressLines: ["Haiwang Community, Xin'an Subdistrict, Bao'an District, Shenzhen", "Room 4302, Building 2, Jinlitong Financial Center, 1100 Xingye Road"],
    contact: "Contact",
    customerService: "Customer service",
    landline: "Landline",
    email: "Email",
    icp: "Guangdong ICP 2025473821-7",
    publicSecurity: "Guangdong Public Security 44030002014945",
  },
} as const;
...
export function LandingPage() {
  ...
  return (
    <div className="min-h-svh w-full bg-[#f7f8fa] text-[#111318]">
      {/* ── 顶部导航 ── */}
      <header className="pf-nav sticky top-0 z-50">
        <div className="pf-nav-left">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            />
            <span className="text-sm font-extrabold tracking-wide text-[#111318]">PRINTFILM</span>
          </Link>
        </div>
        ...
        <div className="pf-nav-right">
          {user ? (
            <Button asChild className="h-9 rounded-lg bg-[#b6ff00] px-4 text-sm font-semibold text-[#111318] hover:bg-[#a8f000]">
              <Link href="/creator">{content.enterCreator} <ArrowRight className="ml-1 size-3.5" /></Link>
            </Button>
          ) : (
              <>
                <Button asChild variant="ghost" className="h-9 rounded-lg text-sm font-medium text-[#62666d] hover:text-[#111318]">
        ...
        <div className="mx-auto grid max-w-[1280px] gap-12 px-4 pb-24 pt-20 md:px-6 md:pb-32 md:pt-28 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
          <div>
            <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-[#dfe3e7] bg-white px-4 py-1.5 text-sm text-[#62666d]">
              <Sparkles className="size-3.5 text-[#78a900]" />
              {content.heroBadge}
            </div>
            <h1 className="text-4xl font-extrabold leading-[1.08] tracking-[-.035em] text-[#111318] md:text-5xl lg:text-6xl">
              {content.heroTitle}
              <br />
              <span className="decoration-[#b6ff00] decoration-[.22em] underline underline-offset-[-.08em]">
                {content.heroAccent}
              </span>
            </h1>
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              <Button asChild size="lg" className="h-12 rounded-lg bg-[#b6ff00] px-6 text-base font-semibold text-[#111318] hover:bg-[#a8f000]">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-12 rounded-lg border-[#d8dce1] bg-white px-6 text-base font-medium text-[#111318] hover:bg-[#f1f3f5]"
              >
                <Link href="/creator">
            ...
            <div className="mt-9 flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-[#62666d]">
              {content.heroPills.map((pill) => (
                <span key={pill} className="inline-flex items-center gap-1.5">
                  <Check className="size-3.5 text-[#78a900]" /> {pill}
                </span>
              ))}
            </div>
          </div>
          <div className="rounded-xl border border-black bg-[#111318] p-3 text-white">
            <div className="flex items-center justify-between border-b border-white/10 px-2 pb-3 text-xs text-white/55">
              <span>PRINTFILM / STUDIO</span>
              <span className="rounded-full bg-[#b6ff00] px-2.5 py-1 font-bold text-[#111318]">AI</span>
            </div>
            <div className="grid min-h-[390px] gap-3 pt-3 md:grid-cols-[150px_1fr]">
              <div className="space-y-2 rounded-lg border border-white/10 bg-white/[.04] p-3">
                {content.workflow.map(([step, title], index) => (
                  <div key={step} className={`flex items-center gap-2 rounded-md px-2 py-2 text-xs ${index === 1 ? "bg-[#b6ff00] font-semibold text-[#111318]" : "text-white/55"}`}>
              ...
              <div className="grid gap-3">
                <div className="relative overflow-hidden rounded-lg border border-white/10 bg-black">
                  ...
                  <Play className="absolute left-1/2 top-1/2 size-12 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#b6ff00] p-3 text-[#111318]" />
                </div>
        ...
        <div className="mx-auto max-w-[1280px] px-4 py-20 md:px-6 md:py-24">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            {content.highlights.map(([title, desc], index) => {
              ...
              >
                <div className="mb-6 flex size-11 items-center justify-center rounded-lg bg-[#b6ff00] text-[#111318]">
      ...
      <section className="bg-white" id="capabilities">
        <div className="mx-auto max-w-[1280px] px-4 py-24 md:px-6 md:py-28">
          <div className="mb-16 text-center">
            <Badge variant="secondary" className="mx-auto mb-4 w-fit rounded-full border-[#d7ed9d] bg-[#efffc7] text-[#466400] hover:bg-[#efffc7]">
              {content.capabilityBadge}
            </Badge>
            <h2 className="text-3xl font-extrabold tracking-tight text-[#111318] md:text-4xl">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {content.capabilities.map(([title, desc], index) => {
              ...
              <div
                ...
                className="group rounded-xl border border-[#e5e7eb] bg-white p-8 transition hover:border-[#cbd0d6]"
              >
                <div className="mb-6 flex size-11 items-center justify-center rounded-lg bg-[#efffc7] text-[#466400]">
                  <Icon className="size-5" />
                </div>
      ...
      {/* ── 工作流 + 适用人群 ── */}
      <section className="bg-[#f7f8fa]" id="workflow">
        <div className="mx-auto max-w-[1280px] px-4 py-24 md:px-6 md:py-28">
          <div className="mb-16 text-center">
            <Badge variant="secondary" className="mx-auto mb-4 w-fit rounded-full border-[#d7ed9d] bg-[#efffc7] text-[#466400] hover:bg-[#efffc7]">
            ...
            {content.workflow.map(([step, title, desc], idx) => (
              <div key={step} className="relative">
                <div className="rounded-xl border border-[#e5e7eb] bg-white p-7 transition hover:border-[#cbd0d6]">
                  <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#b6ff00] text-xs font-bold text-[#111318]">
                    {step}
                  </span>
                  <h3 className="mt-5 text-base font-bold text-[#111318]">{title}</h3>
                  <p className="mt-4 text-sm leading-6 text-[#62666d]">{desc}</p>
                </div>
                {/* 步骤间箭头 (桌面端) */}
            ...
            <div className="grid gap-px bg-[#e5e7eb] md:grid-cols-2">
              {content.features.map((x) => (
                <div key={x} className="flex items-center gap-3 bg-white px-12 py-6 text-sm">
                  <Check className="size-4 shrink-0 text-[#78a900]" />
                  <span className="text-[#111318]">{x}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* ── FAQ ── */}
      <section className="bg-[#f7f8fa]" id="faq">
        <div className="mx-auto max-w-[1280px] px-4 py-24 md:px-6 md:py-28">
          <div className="mb-16 text-center">
            <h2 className="text-3xl font-extrabold tracking-tight text-[#111318] md:text-4xl">
              {content.faqTitle}
          ...
          <div className="mx-auto max-w-2xl divide-y divide-[#e5e7eb] overflow-hidden rounded-xl border border-[#e5e7eb] bg-white">
            {content.faqs.map(([question, answer]) => (
              <div key={question} className="p-10">
                <h3 className="text-base font-bold text-[#111318]">{question}</h3>
      ...
      <section className="bg-[#f7f8fa]">
        <div className="mx-auto max-w-[1280px] px-4 py-24 md:px-6 md:py-28">
          <div className="relative overflow-hidden rounded-xl border border-black bg-[#111318] p-16 text-center md:p-24">
        ...
        <div className="mx-auto max-w-[1280px] px-4 py-16 md:px-6">
          <div className="grid gap-8 sm:grid-cols-2">
            <div className="space-y-3 text-sm text-[#62666d]">
              <div>
                <div className="text-lg font-extrabold text-[#111318]">{APP_NAME}</div>
                <div className="mt-0.5">{content.footerTagline}</div>
              </div>
              <div>
                <div className="font-medium text-[#111318]">{content.officeAddress}</div>
                {content.addressLines.map((line) => <div key={line}>{line}</div>)}
              </div>
            </div>
            <div className="space-y-3 text-sm text-[#62666d] sm:text-right">
              <div className="text-lg font-extrabold text-[#111318]">{content.contact}</div>
              <div>
                <div className="font-medium text-[#111318]">{content.contact}</div>
                <div>{content.customerService}: <a href="tel:15692096568" className="transition hover:text-[#111318]">156 9209 6568</a></div>
                <div>{content.landline}: <a href="tel:0755-27337894" className="transition hover:text-[#111318]">0755-27337894</a></div>
                <div>{content.email}: <a href="mailto:contact@gitgg.com" className="transition hover:text-[#111318]">contact@gitgg.com</a></div>
              </div>
            </div>
          </div>
          <div className="mt-12 flex flex-col items-center gap-3 border-t border-[#e5e7eb] pt-10 text-xs text-[#62666d]">
            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
              <a href="https://beian.miit.gov.cn/#/Integrated/index" target="_blank" rel="noreferrer" className="transition hover:text-[#111318]">
                {content.icp}
              </a>
              <a href="https://beian.mps.gov.cn/#/query/webSearch" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 transition hover:text-[#111318]">
