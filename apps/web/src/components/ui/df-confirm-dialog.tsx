...
export function DfConfirmDialog({
  ...
  const iconStyles: Record<DfConfirmVariant, string> = isDark
    ? {
        default: "bg-[#b6ff00]/15 text-[#d4ff66] ring-1 ring-[#b6ff00]/25",
        danger: "bg-red-500/15 text-red-300 ring-1 ring-red-500/25",
        success: "bg-[#b6ff00]/15 text-[#d4ff66] ring-1 ring-[#b6ff00]/25",
      }
    : {
        default: "bg-[#f4ffd6] text-[#6f9d00] ring-1 ring-[#e3ffa3]",
        danger: "bg-red-50 text-red-500 ring-1 ring-red-100",
        success: "bg-[#f4ffd6] text-[#6f9d00] ring-1 ring-[#e3ffa3]",
      };
  ...
  const confirmClass =
    variant === "danger"
      ...
      : variant === "success"
        ? "bg-[#b6ff00] text-[#111318] shadow-sm hover:bg-[#a8f000]"
        : "bg-[#b6ff00] text-[#111318] shadow-sm hover:bg-[#a8f000]";
