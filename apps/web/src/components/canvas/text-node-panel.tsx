...
import type { CanvasNodeData, CanvasNodeType } from "@printfilm/shared-types";
  ...
  return (
    <DfScrollArea className="w-80 shrink-0 border-l border-white/70 bg-white/78 p-4 shadow-[-8px_0_28px_rgba(15,55,95,.08)] backdrop-blur-xl">
      ...
      <div className="mt-4 space-y-3">
        ...
        <div className="space-y-3 rounded-xl border border-[#e5e7eb] bg-[#f7f8fa] p-3">
          <div>
            <p className="text-xs font-medium text-[#111318]">{meta.label}</p>
          ...
          <label className="block">
            ...
            <textarea
              ...
              className="mt-1 w-full resize-none rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 outline-none focus:border-[#8bc400] focus:ring-2 focus:ring-[#8bc400]/15"
            />
          </label>
          ...
          <button
            ...
            disabled={loading}
            className="w-full rounded-lg bg-[#b6ff00] py-2 text-sm font-semibold text-[#111318] hover:bg-[#a8f000] disabled:opacity-60"
          >
