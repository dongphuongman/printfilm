      ...
      <div className="flex items-center justify-between">
        ...
        {showApply && onApply && (
          <button
            type="button"
            onClick={onApply}
            className="text-xs font-medium text-[#111318] underline-offset-2 hover:underline"
          >
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-1.5">
                  ...
                  {hasOutput && (
                    <span className="shrink-0 text-[10px] text-[#6f9d00]">{t("dramaforge.canvas.hasOutput")}</span>
                  )}
                </div>
