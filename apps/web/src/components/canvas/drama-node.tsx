  ...
  return (
    <div
      className={`overflow-hidden rounded-xl border bg-white/92 shadow-[0_10px_28px_rgba(15,55,95,0.14)] backdrop-blur ${
        selected ? "border-[#8bc400] ring-2 ring-[#8bc400]/20" : "border-white"
      } ${isPrompt ? "min-w-[240px] max-w-[280px]" : "min-w-[180px] max-w-[220px]"}`}
    >
      <Handle
        type="target"
        position={Position.Left}
        className="!-left-1.5 !h-2.5 !w-2.5 !border-2 !border-white !bg-[#8bc400]"
      />
        ...
        <div className="relative flex aspect-[4/3] w-full items-center justify-center bg-slate-100">
          ...
          {selected ? (
            ...
            <div className="flex flex-col items-center gap-1 text-slate-500">
              <span className="flex h-8 w-8 items-center justify-center rounded-full border border-slate-300 bg-white text-sm text-[#111318] shadow-sm">
                ▶
              </span>
