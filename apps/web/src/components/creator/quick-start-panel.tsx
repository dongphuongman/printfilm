        ...
        <div className="mb-2 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-lg px-2 py-1 text-[10px] font-medium text-[#6f9d00] transition hover:bg-secondary"
            >
              {isZh ? "查看文档" : "Docs"}
            </a>
            <button
          ...
          return (
            <button
              ...
              className={`block w-full rounded-xl px-3 py-2.5 text-left transition ${
                selected
                  ? "bg-secondary ring-1 ring-[#8bc400]/30"
                  : "hover:bg-white/70"
              }`}
            >
              ...
              return (
                <button
                  ...
                  className={`rounded-lg px-3 py-2 text-left text-xs transition whitespace-nowrap sm:whitespace-normal ${
                    selected
                      ? "bg-secondary font-medium text-[#111318] ring-1 ring-[#8bc400]/30"
            ...
            <ol className="space-y-4">
              {steps.map((step, index) => (
                <li key={step.title} className="flex gap-3">
                  <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-secondary text-[11px] font-semibold text-[#111318]">
                    {index + 1}
                  </span>
                  <div>
        ...
        <div className="flex flex-wrap items-center justify-end gap-2 border-t border-border px-5 py-3">
          ...
          {cta && (
            <button
              ...
              className="rounded-xl bg-[#b6ff00] px-4 py-2 text-sm font-semibold text-[#111318] hover:bg-[#a8f000]"
            >
              {cta.label}
            </button>
          )}
