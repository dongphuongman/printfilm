...
import type { DramaForgePipelineStage } from "@printfilm/shared-types";
import { DRAMA_FORGE_PIPELINE_STAGES, canAdvanceToStep } from "@printfilm/shared-types";
        ...
        {DRAMA_FORGE_PIPELINE_STAGES.map((stage, index) => {
          ...
          return (
            <button
              ...
              style={
                selected
                  ? { borderColor: "rgba(139, 196, 0, 0.5)", backgroundColor: "#f4ffd6" }
                  : done
            ...
            >
              <span
                style={
                    ...
                    ? { backgroundColor: "#b6ff00", color: "#111318" }
                    : selected
                      ? { backgroundColor: "#b6ff00", color: "#111318" }
                      : undefined
                }
        ...
        <div className="flex justify-between gap-2">
          ...
          {onNext && (
            <button
              ...
              className="rounded-lg bg-[#b6ff00] px-3 py-1.5 text-xs font-semibold text-[#111318] disabled:opacity-40"
            >
