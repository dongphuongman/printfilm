...
import type {
  ...
  DramaForgeJob,
} from "@printfilm/shared-types";
import { defaultDramaForgeAspectRatio } from "@printfilm/shared-types";
...
const RUNS_STORAGE_PREFIX = "printfilm.quickEpisode.runs.v1";
const ACTIVE_RUN_STORAGE_PREFIX = "printfilm.quickEpisode.activeRun.v1";
    ...
    <div className="pf-shell-main max-w-3xl space-y-6">
      <header className="pf-page-head">
        <div className="mb-2 flex items-center gap-2">
          <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#b6ff00]">
            <Sparkles className="h-4 w-4 text-[#111318]" />
          </span>
      ...
      <div className="pf-panel pf-panel-pad">
        <label className="mb-2 block text-sm font-medium text-[#111318]">
        ...
        <textarea
          ...
          className="w-full resize-y rounded-xl border border-[#dfe2e6] bg-[#f7f8fa] px-3 py-2.5 text-sm text-[#111318] outline-none transition focus:border-[#8bc400] focus:ring-2 focus:ring-[#8bc400]/15 disabled:opacity-60"
        />
        <div className="mt-3 flex flex-wrap items-center justify-between gap-3">
              ...
              <button
                ...
                className={`rounded-full border px-3 py-1.5 text-xs transition disabled:opacity-60 ${
                  aspectRatio === opt.value
                    ? "border-[#8bc400] bg-[#f4ffd6] text-[#111318]"
                    : "border-[#e5e7eb] text-[#62666d] hover:text-[#111318]"
                }`}
              >
                {t(opt.labelKey)}
              </button>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              onClick={handleStart}
              className="inline-flex items-center gap-2 rounded-xl bg-[#b6ff00] px-5 py-2.5 text-sm font-semibold text-[#111318] transition hover:brightness-95 disabled:cursor-not-allowed disabled:opacity-50"
            >
        ...
        {!user ? (
          <p className="mt-3 text-xs text-[#e11d48]">
            ...
            <Link href="/login" className="text-[#6f9d00] underline">
          ...
          <p className="mt-3 text-xs text-[#e11d48]">
            ...
            <Link href="/creator?mode=settings" className="text-[#6f9d00] underline">
      ...
      <div className="mt-5 rounded-2xl border border-[#e5e7eb] bg-white p-5">
        <div className="mb-3 flex items-center justify-between gap-2">
          <h2 className="text-sm font-semibold text-[#111318]">{t("quickEpisode.runsTitle")}</h2>
        </div>
        {runs.length === 0 ? (
              ...
              return (
                <div
                  ...
                  className={`rounded-xl border px-3 py-2.5 text-xs transition ${
                    selected
                      ? "border-[#8bc400] bg-[#f4ffd6]"
                      : "border-[#e5e7eb] bg-[#f7f8fa] hover:border-[#cbd0d6]"
                  }`}
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="flex shrink-0 flex-col items-end gap-1">
                      <Link
                        ...
                        className="text-[10px] text-[#6f9d00] underline"
      ...
      {showProgress && (
        <div className="mt-5 rounded-2xl border border-[#e5e7eb] bg-white p-5">
          <h2 className="mb-4 text-sm font-semibold text-[#111318]">{t("quickEpisode.progressTitle")}</h2>
              ...
              return (
                <li key={key} className="flex items-start gap-3">
                  <span className="mt-0.5 shrink-0">
                    {state === "done" ? (
                      <CheckCircle2 className="h-5 w-5 text-[#6f9d00]" />
                    ) : state === "running" ? (
                      <Loader2 className="h-5 w-5 animate-spin text-[#8bc400]" />
                    ) : state === "failed" ? (
                  ...
                  <div className="min-w-0 flex-1">
                    <p
                      className={`text-sm font-medium ${
                        state === "idle" ? "text-[#9aa0a6]" : "text-[#111318]"
                      }`}
                    >
          ...
          {(error || canContinue) && projectId && (
            <div className="mt-4 space-y-2 rounded-xl border border-[#e11d48]/30 bg-[#e11d48]/5 px-3 py-2.5 text-xs text-[#62666d]">
              <p>
                ...
                <Link href={`/studio/${projectId}`} className="text-[#6f9d00] underline">
                  {t("quickEpisode.openStudio")}
                </Link>
              </p>
            </div>
          ...
          {outputUrl && (
            <div className="mt-5 space-y-3">
              <h3 className="text-sm font-semibold text-[#111318]">{t("quickEpisode.resultTitle")}</h3>
              <video src={outputUrl} controls className="w-full rounded-xl bg-black" />
              <div className="flex flex-wrap items-center gap-4 text-xs">
                <a href={outputUrl} target="_blank" rel="noreferrer" className="text-[#6f9d00] underline">
      ...
      <div className="mt-5 rounded-2xl border border-[#e5e7eb] bg-[#f7f8fa] p-4 text-xs leading-relaxed text-[#62666d]">
        <p className="mb-1 font-medium text-[#111318]">{t("quickEpisode.howItWorksTitle")}</p>
