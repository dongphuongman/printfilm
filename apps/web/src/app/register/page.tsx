    ...
    <div className="grid min-h-svh lg:grid-cols-2">
      <section className="flex min-h-svh flex-col bg-white px-6 py-8 md:px-12 lg:px-16">
        <Link href="/" className="mb-10 flex items-center gap-2.5">
          <span className="relative flex size-8 overflow-hidden rounded-lg bg-[#111318]">
            <Image src="/brand-icon.png" alt="" width={32} height={32} className="size-8 object-cover" />
          </span>
          <span className="text-sm font-extrabold tracking-wide">PRINTFILM</span>
        </Link>
        <div className="my-auto w-full max-w-md">
          <h1 className="text-3xl font-extrabold tracking-tight text-[#111318]">{t("auth.registerHeroTitle")}</h1>
