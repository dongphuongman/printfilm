...
class ProjectControllerTest {
    ...
    void projectCrudFlow() throws Exception {
        var createRequest = new CreateProjectRequest("测试短剧", com.printfilm.api.domain.ProjectType.SHORT_DRAMA, "描述");
