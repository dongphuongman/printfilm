...
public class DramaForgeJobWorker {
    ...
    @Scheduled(fixedDelayString = "${printfilm.dramaforge.poll-interval-ms:1000}")
    public void poll() {
    ...
    private com.printfilm.api.dramaforge.domain.DramaForgeJob claimNextSafely() {
        try {
