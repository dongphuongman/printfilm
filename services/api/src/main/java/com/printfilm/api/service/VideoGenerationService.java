...
import com.printfilm.api.client.ArkSeedanceClient;
import com.printfilm.api.config.ArkApiKeyContext;
import com.printfilm.api.config.ArkApiKeyResolver;
import com.printfilm.api.config.ArkProperties;
...
import com.printfilm.api.dto.VideoGenerationResponse;
import com.printfilm.api.dto.VideoModelResponse;
...
import com.printfilm.api.util.MediaSizeHelper;
...
public class VideoGenerationService {
    ...
    private VideoGenerationResponse createInternal(UUID userId, CreateVideoGenerationRequest request) {
        ...
        job.setMediaType(com.printfilm.api.domain.GenerationMediaType.VIDEO);
