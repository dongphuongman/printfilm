...
import com.printfilm.api.client.TokenFreeClient.ChatMessage;
...
public class DramaForgeAgentService {
    ...
    private AgentChatResponse tryQuickAction(
            ...
            String apiKey,
            List<com.printfilm.api.dramaforge.domain.DramaForgeEpisode> episodes) {
    ...
    private UUID resolveEpisodeId(
        ...
        if (episodeNumber != null) {
            return episodes.stream()
                    ...
                    .map(com.printfilm.api.dramaforge.domain.DramaForgeEpisode::getId)
                    .findFirst()
                    .orElse(null);
        }
